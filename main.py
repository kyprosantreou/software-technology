...
def main():
    ...
    with tab2:
        ...
        with tab6:
            ...
            st.write(""" 
                    Δημιουργεί ένα μοντέλο που προβλέπει την τιμή στόχο με βάση κανόνες από τα χαρακτηριστικά εισόδου.
                    Στην συνέχεια, χωρίζει το σύνολο δεδομένων μας σε μικρότερα υποσύνολα με βάση τα χαρακτηριστικά, δημιουργώντας ένα δέντρο αποφάσεων.
                    Σε κάθε κόμβο του δέντρου λαμβάνει απόφαση για το πώς να χωρίσει τα δεδομένα χρησιμοποιώντας κριτήρια όπως η εντροπία ή το Gini index.
                    \nΧρησιμος για:
            ...
            st.write("""
                    ...
                    Με βάση τα αποτελέσαμτα, ο αλγίριθμος  Decision tree είναι ακριβέστερος για την ανάλυση των δεδομένων.
                    Ο λόγος που έιναι ποιο αποτελεσματικός, είναι γιατί το σύνολο δεδομένων μας περιήχε δεδομένα απο άτομα
                    που επασχαν απο καρδιακά προβήματα και απο μη πασχών άτομα. Έτσι, ο αλγόριθμος, με την βοήθεια των ετικετών,
                    για την κατανόηση των μοτίβων με τα χαρακτησριστικά των ασθενών μπορεί να καταλήξει σε συμπέρασμα για το αν κάποιος
                    πάσχει απο καρδιακά προβλήματα ή όχι.
                    """)
